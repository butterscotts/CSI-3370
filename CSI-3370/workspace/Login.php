...
<div id="login">
	<form action="/Pages/CheckLogin.php" method="post">
		<p><input type="text" name="user" id="user" style="border-radius: 20px; rgba(25,223,1,.1) no-repeat" placeholder="username"></p>
		<p><input type="password" name="passw0rd" id="pwd" style="border-radius: 20px" placeholder="password"></p>
                <p><td><input type="submit" id="submit" style="background: #CC6FA2; font-weight: bold" value="SUBMIT"><label>
                  <input type="reset" id="submit" style="background: #CC6FA2; font-weight: bold" value="RESET"></label></td></p><br><br>
                  <a id="dick" class="doubledick"  href="/Create.php">No Account? Click Here to Sign Up!</a>
